...
# python3 main2.py --prefix fresh_run --data-dir "../Experimental results" --max-step 100 --batch-size 1 --test-step 100 --vgg16-path "./vgg16.npy"
...
def print_gpu_info():
    ...
    try:
        for d in device_lib.list_local_devices():
            print(f"{d.name:20} {d.device_type}")
...
class DeepFeatureNetwork:
    def __init__(self, input_size, model_func, model_path, gpu_num):
        ...
        try:
            print("Feature tensor device:", self.feature.device)
        except Exception:
            pass
...
if __name__ == '__main__':
    ...
    try:
        print("Visible GPUs:", tf.config.experimental.list_physical_devices('GPU'))
    except Exception:
        pass
