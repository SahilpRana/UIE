# python main.py --prefix fresh_run --data-dir "c:\UIE\n\Experimental results" --max-step 100 --batch-size 1 --test-step 100 --vgg16-path "c:\UIE\n\RL\vgg16.npy"
